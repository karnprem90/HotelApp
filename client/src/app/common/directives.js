        ...
        link: function(scope, element, attrs) {
            ...
            element.bind('change', function(){
                scope.$apply(function(){
                    ...
                    scope.change({fil:element[0].files[0]});
                });
            });
        }
    };
...
.directive('timePicker', function() {
  return {
    ...
    replace: true,
    link: function(scope, element, attrs) {
      scope.timings = ['7am-8am', '8am-9am', '9am-10am', '10am-11am', '11am-12pm', '12pm-1pm',
        '1pm-2pm', '2pm-3pm', '3pm-4pm', '4pm-5pm', '5pm-6pm', '6pm-7pm',
        '7pm-8pm', '8pm-9pm', '9pm-10pm', '10pm-11pm', '11pm-12am', '12am-1am', '1am-2am', '2am-3am',
